...
$LOGO_FILE = $CFG->wwwroot.'/mod/certificate/pix/' .CERT_IMAGE_SIGNATURE. '/logo_etwinning.png';
...
$filename = $path . '/cert_opensimweb2_'. strtolower($role). '.html';
...
$statement = str_replace("%SIGN_NAME_ETWINNING%", 'Δρ Μιχάλης Παρασκευάς' ,$statement);
